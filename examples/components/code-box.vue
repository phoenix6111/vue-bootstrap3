<template lang="html">
    ...
    <section class="code-box" :class="{'expand': open}">
        <section class="code-box-demo" ref="codeDefault">
            <slot></slot>
        </section>
        ...
        <section class="highlight-wrapper" :class="{'highlight-wrapper-expand': open}">
            <div class="highlight">
                <pre v-beauty-code:html>
                  <code class="code" ref="codeSlot"><slot name="vueCode"></slot></code>
                </pre>
            </div>
            <div v-if="$slots.js" class="highlight" v-beauty-code:js>
                <pre>
                  <code class="code" ref="jsSlot">{{jsCode}}</code>
                </pre>
            </div>
            <div v-if="$slots.css" class="highlight" v-beauty-code:css>
                <pre>
                  <code class="code" ref="cssSlot">{{cssCode}}</code>
                </pre>
            </div>
        </section>
    </section>
...
<script lang="babel">
    ...
    export default {
        ...
        beforeCreate() {
            const codeDemo = document.querySelector('.code-box-demo');
        ...
        methods: {
            slotHandle(slot = 'default', type = 'html'){
                ...
                return (_slot && _slot[0] && _slot[0].text) ? _slot[0].text : false;
            },
            handleOpen() {
                this.open = !this.open;
            }
