    ...
    <div
        ...
        <transition
            ...
            <el-select-menu
                ...
                <p class="el-select-dropdown__empty" v-if="emptyText && !allowCreate">{{ emptyText
                    }}</p>
            </el-select-menu>
        </transition>
    </div>
...
<script type="text/babel">
    ...
    export default {
        ...
        computed: {
            iconClass() {
                let criteria = this.clearable && !this.disabled &&
                    ...
                    this.value !== '';
                return criteria ? 'close-circle is-show-close' : (this.remote && this.filterable ? '' : 'chevron-down');
            },
        ...
        methods: {
            ...
            handleIconShow() {
                let icon = this.$el.querySelector('.input-icon');
                if (icon && !hasClass(icon, 'zmdi-close-circle')) {
            ...
            handleIconClick(event) {
                if (this.iconClass.indexOf('close-circle') > -1) {
