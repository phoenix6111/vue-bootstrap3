export default {
    ...
    render(h) {
        ...
        return (
            <table
                class={['el-table__footer table',this.border?'table-bordered':'',this.size?'table-'+this.size:'']}
                cellspacing="0"
                cellpadding="0"
                border="0">
                <colgroup>
                    ...
                    }
                    {
                        !this.fixed && this.layout.gutterWidth
                            ? <col name="gutter"
                                   width={ this.layout.scrollY ? this.layout.gutterWidth : '' }></col>
                            : ''
                    }
                </colgroup>
                <tbody>
                <tr>
                    ...
                    }
                    {
                        !this.fixed && this.layout.gutterWidth
                            ? <td class="gutter"
                                  style={{width: this.layout.scrollY ? this.layout.gutterWidth + 'px' : '0'}}></td>
                            : ''
                    }
                </tr>
                </tbody>
